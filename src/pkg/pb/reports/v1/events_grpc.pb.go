...
const (
	EventService_AnalyzeEvents_FullMethodName = "/report.v1.EventService/AnalyzeEvents"
	EventService_ExportEvents_FullMethodName  = "/report.v1.EventService/ExportEvents"
	EventService_ListEvents_FullMethodName    = "/report.v1.EventService/ListEvents"
	EventService_SearchEvents_FullMethodName  = "/report.v1.EventService/SearchEvents"
)
...
// این سرویس برای آنالیز، خروجی گرفتن، لیست‌گیری و جستجوی حرفه‌ای رویدادها طراحی شده
type EventServiceClient interface {
	// آنالیز رویدادها بر اساس فیلترهای مختلف
	AnalyzeEvents(ctx context.Context, in *AnalyzeEventsRequest, opts ...grpc.CallOption) (*AnalyzeEventsResponse, error)
	// خروجی گرفتن از رویدادها
	ExportEvents(ctx context.Context, in *ExportEventsRequest, opts ...grpc.CallOption) (*ExportEventsResponse, error)
	// دریافت لیست رویدادها با صفحه‌بندی و فیلتر
	ListEvents(ctx context.Context, in *ListEventsRequest, opts ...grpc.CallOption) (*ListEventsResponse, error)
	// جستجوی پیشرفته در رویدادها
...
func (c *eventServiceClient) AnalyzeEvents(ctx context.Context, in *AnalyzeEventsRequest, opts ...grpc.CallOption) (*AnalyzeEventsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AnalyzeEventsResponse)
	err := c.cc.Invoke(ctx, EventService_AnalyzeEvents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EventServiceServer interface {
	// آنالیز رویدادها بر اساس فیلترهای مختلف
	AnalyzeEvents(context.Context, *AnalyzeEventsRequest) (*AnalyzeEventsResponse, error)
	// خروجی گرفتن از رویدادها
...
func (UnimplementedEventServiceServer) AnalyzeEvents(context.Context, *AnalyzeEventsRequest) (*AnalyzeEventsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AnalyzeEvents not implemented")
}
...
func _EventService_AnalyzeEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AnalyzeEventsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EventServiceServer).AnalyzeEvents(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventService_AnalyzeEvents_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).AnalyzeEvents(ctx, req.(*AnalyzeEventsRequest))
	}
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "report.v1.EventService",
	HandlerType: (*EventServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AnalyzeEvents",
			Handler:    _EventService_AnalyzeEvents_Handler,
		},
		{
	...
	Metadata: "reports/v1/events.proto",
}
